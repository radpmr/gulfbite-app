...
GROUP_REASONS = {
    "rice_cluster": "Rice dishes like Machboos, Kabsa, and Biryani share aromatic spice bases, so we double-check.",[cite: 1]
    "wrap_cluster": "Wrapped dishes hide their core filling, so we double-check with you.",[cite: 1]
}[cite: 1]
...
DISH_BLURBS = {
    ...
    "07_ouzi": "Spiced spiced rice loaded with slow-roasted tender lamb and toasted golden nuts.",[cite: 1]
...
.hero-img-wrap {
    ...
    width: 100%;
    height: 330px;
    background-image: url('https://images.unsplash.com/photo-1541544741938-0af808871cc0?auto=format&fit=crop&w=800&q=80');
...
.hero-overlay {
    position: absolute;
    inset: 0;
    background: linear-gradient(180deg, rgba(0,0,0,0.05) 0%, rgba(249,247,242,0.1) 50%, #F9F7F2 100%);
}
...
if st.session_state.stage == "onboarding":
    # Hero Visual with AI Decoded Floating Badges
    st.markdown(
        """<div class="hero-container">
    <div class="hero-img-wrap">
        <div class="floating-pill" style="top: 24px; left: 16px;">
            <span class="pill-dot"></span>
            <span>170 kcal</span>
        </div>
        <div class="floating-pill" style="top: 30px; right: 16px;">
            <span class="pill-dot"></span>
            <span>110 kcal</span>
        </div>
        <div class="floating-pill" style="top: 110px; left: 50%; transform: translateX(-50%);">
            <span class="pill-dot"></span>
            <span>90 kcal</span>
        </div>
...
<div style="text-align: center; padding: 0.6rem 0.8rem 1.6rem 0.8rem;">
    ...
    <p style="color: #7A7468; font-size: 0.95rem; font-weight: 500; margin: 12px auto 20px auto; max-width: 320px; line-height: 1.45;">
    ...
    <div style="display: flex; justify-content: center; gap: 6px; margin-bottom: 24px;">
        <span style="width: 22px; height: 6px; border-radius: 999px; background: #1C1917;"></span>
