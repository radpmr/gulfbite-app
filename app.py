...
@media (max-width: 768px) {
    ...
    st.markdown(
        ...
        <style>
        /* ================================================================
           STABLE HTML DISH PICKER
           Pure HTML <details> + links: no Streamlit dropdown, radio, or
           option buttons, so the earlier black/blank/oversized states cannot
           be inherited from global widget styling.
           ================================================================ */
        ...
        .html-dish-picker > summary::-webkit-details-marker {
            display: none !important;
        }

        .html-dish-picker > summary::marker {
            display: none !important;
            content: "" !important;
        }
        ...
        .html-dish-picker[open] .html-dish-chevron {
        ...
        .html-dish-options::-webkit-scrollbar {
            width: 5px !important;
        }

        .html-dish-options::-webkit-scrollbar-track {
            background: transparent !important;
        }
